...
public class cla_sis implements Serializable {
	...
	public String toString() {
		return "cla_sis [id_sis=" + id_sis + ", reg_id=" + reg_id + ", reg_data=" + reg_data + ", reg_alt=" + reg_alt
				...
				+ ", tel_1=" + tel_1 + ", email_1=" + email_1 + ", obs=" + obs + ", titulo_web=" + titulo_web + "]";
	}

	@Override
	public int hashCode() {
		return Objects.hash(titulo_web, ace_per_aut, cnpj_cpf, email_1, end_bar, end_cep, end_com, end_mun, end_num,
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(titulo_web, other.titulo_web) && Objects.equals(ace_per_aut, other.ace_per_aut)
