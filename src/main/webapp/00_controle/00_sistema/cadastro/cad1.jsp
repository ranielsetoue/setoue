										...
										<div class="row align-items-center text-center text-md-left">
											<div
												...
												<textarea name="end_rua" id="end_rua" autocomplete="off"
													...
													style="overflow: hidden; resize: none;" 
													oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"><c:out value="${listaResultados[0].end_rua}" escapeXml="true"/></textarea>
											</div>
											...
											<div
												...
												<textarea name="end_com" id="end_com"
													autocomplete="off" class="form-control"
													placeholder="Complemento" rows="1"
													style="overflow: hidden; resize: none;"
													oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';">${pre_glo.nome_desc}</textarea>
											</div>
										</div>
										...
										<div class="row align-items-center text-center text-md-left">
											<div
												...
												<textarea name="end_bar" id="end_bar" autocomplete="off"
													class="form-control" placeholder="Bairro" rows="1"
													style="overflow: hidden; resize: none;"
													oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';">${pre_glo.nome_desc}</textarea>
											...
											<div
												...
												<label id="l_end_mun" data-placeholder="Município"></label>
												<textarea name="end_mun" id="end_mun" autocomplete="off"
													class="form-control" placeholder="Municipio" rows="1"
													style="overflow: hidden; resize: none;"
													oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';">${pre_glo.nome_desc}</textarea>
			...
			<c:if test="${cons_true}">
				<div class="container mt-3">
					...
					<div class="row align-items-center text-center text-md-left">
						...
						<div
							class="col-12 col-md-4 mb-2 mb-0 align-self-center text-center">
												<label id="l_email_rec" data-placeholder="E-mail"></label>
												<textarea name="email_rec" id="email_rec" class="form-control"
													placeholder="E-mail" autocomplete="off" rows="1"
													style="overflow: hidden; resize: none;"
													oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"></textarea>
						...
						<div
							class="col-12 col-md-4 mb-2 mb-0 align-self-center text-center">
												<label id="l_login" data-placeholder="Login"></label>
												<textarea name="login" id="login" class="form-control"
													placeholder="Login" autocomplete="off" rows="1"
													style="overflow: hidden; resize: none;"
													oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"></textarea>
						...
						<div
							class="col-12 col-md-4 mb-2 mb-0 align-self-center text-center">
												<label id="l_senha" data-placeholder="Senha"></label>
												<textarea name="senha" id="senha" class="form-control"
													placeholder="Senha" autocomplete="off" rows="1"
													style="overflow: hidden; resize: none;"
													oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"></textarea>
...
<hr>										
    ...
    window.addEventListener('DOMContentLoaded', function() {
         document.getElementById('cnpj_cpf').value = '<c:out value="${listaResultados[0].cnpj_cpf}" escapeXml="true"/>';
          document.getElementById('nome_desc').value = '<c:out value="${listaResultados[0].nome_desc}" escapeXml="true"/>';
          document.getElementById('no_fan').value = '<c:out value="${listaResultados[0].no_fan}" escapeXml="true"/>';
          document.getElementById('ins_est').value = '<c:out value="${listaResultados[0].ins_est}" escapeXml="true"/>';
          document.getElementById('ins_mun').value = '<c:out value="${listaResultados[0].ins_mun}" escapeXml="true"/>';
          document.getElementById('end_rua').value = '<c:out value="${listaResultados[0].end_rua}" escapeXml="true"/>';
          document.getElementById('end_num').value = '<c:out value="${listaResultados[0].end_num}" escapeXml="true"/>';
          document.getElementById('end_com').value = '<c:out value="${listaResultados[0].end_com}" escapeXml="true"/>';
          document.getElementById('end_bar').value = '<c:out value="${listaResultados[0].end_bar}" escapeXml="true"/>';
...
function paginarTabela(tabelaId, linhasPorPagina = 20) {
	...
	<script>
window.onload = () => paginarTabela('tab1_result', 5);
</script>
